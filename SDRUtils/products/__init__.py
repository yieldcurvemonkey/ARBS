...
- usd: USD products (USD swaps, swaptions, etc.)
...
- Product-specific modules (e.g., usd_swaps.py, swaptions.py)
...
from SDRUtils.products.filters import new_sofr_swap_trades, new_usd_swap_trades
