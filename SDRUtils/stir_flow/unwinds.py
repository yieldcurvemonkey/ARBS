...
Findings from the lineage probe (Task 5 Step 1): No lineage columns (original_dissemination_identifier, prior_uti, prior_usi) found in arbs_usd_swap_tape_legs_v2 as of 2026-07-14. Zero ECONOMIC_UNWIND rows on 07/10. extract_unwind_events returns empty frame; netting is a no-op.
