...
share is just ``(k-1)·0.142 / (1 + (k-1)·0.142)`` -- 12.4% at k = 2.0, 13.5% at
...
#: than typed -- 18 × 8 hand-copied numbers is how a calibration acquires a typo
...
class Imputation:
    ...
    #: ``factor × printed notional``, in its own field. The consumer decides.
