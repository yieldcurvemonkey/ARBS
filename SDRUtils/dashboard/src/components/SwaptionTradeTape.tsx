// ABOUTME: USD Swaptions Trade Tape table (event action + package summary) powered by arbs_swaption_display_items_v1
"use client";
...
export default function SwaptionTradeTape() {
  ...
  const buildTradeLabel = (row: TapeRow) => buildRichLabel(row);
