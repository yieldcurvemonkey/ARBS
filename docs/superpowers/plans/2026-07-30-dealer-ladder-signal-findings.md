...
- **197 declared items did not run**, of which **5 have no recorded reason**.
...
| conditioning split | sofr_effr_bp                            | declared, no stratum reported         |
| audit              | not_yet_visible_poison                  | declared in the battery, not reported |
...
_Audited against `C:/Users/chris/clee/ARBS-ladder/BT/results/dealer_ladder`._
