...
from RVUtils.Interpolation.BjorkChristensen import BjorkChristensenCurve
from RVUtils.Interpolation.BjorkChristensenAugmented import BjorkChristensenAugmentedCurve
from RVUtils.Interpolation.calibrate import (
...
from RVUtils.Interpolation.DieboldLi import DieboldLiCurve
from RVUtils.Interpolation.MLESM import MerrillLynchExponentialSplineModel
from RVUtils.Interpolation.MonotoneConvex import MonotoneConvex
...
class GeneralCurveInterpolator:
    ...
    def b_spline_with_knots_interpolation(self, knots: Optional[npt.ArrayLike], k: Optional[int] = 3, return_func=True) -> np.ndarray:
    ...
    def loess_interpolation(self, frac: Optional[float] = 0.3, it: Optional[int] = 2, delta: Optional[float] = 0.0, return_func: Optional[bool] = True):
