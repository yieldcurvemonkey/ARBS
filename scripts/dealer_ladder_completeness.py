...
STAGES = {
    ...
    "G0 independent-mid flip study": ["g0_flip_rate", "g0_mid_offset_bps"],
    ...
    "G2 flow-response event study": ["g2_flow_response_FUTURES"],
...
def render(res, results_dir) -> str:
    inv = res["inventory"]
    lines = ["## Completeness pass", "",
