...
Usage::
    ...
    python notebooks/rv/_audit_fed_event_conditioning_numbers.py [notebook.ipynb]
"""
...
DEFAULT_NB = HERE / "fed_event_conditioning_rv.ipynb"

#: Figures the findings block quotes but does not recompute, each with its source.
WHITELIST = {
    # ---- cited from the four merged PRs, not recomputed here ----
    "0.12": "fedlock_sentiment_lead: the 21-year correlation at the surviving lead",
    "2048": "fed_detachment_rv: its cell count",
    "0.773": "fed_sentiment_lead: the point-in-time correlation at +14w",
    # ---- structural / process constants ----
    **{t: "structural" for t in (
        "490", "491", "497", "501",            # the PR numbers
        "11", "14", "19", "2026", "2025", "2023", "2021", "2003", "1994", "1985",
        "0.50", "2.0",
    )},
}
