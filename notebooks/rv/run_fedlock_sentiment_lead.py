"""Build, execute and verify the FedLock replication of the lead study.
...
Usage::
    ...
    conda run -n stir python notebooks/rv/run_fedlock_sentiment_lead.py --no-exec
...
def main(argv=None) -> int:
    ...
    rc_numbers = _run(
        [sys.executable, str(HERE / "_audit_fedlock_numbers.py"), str(nb)],
        REPO,
    )
