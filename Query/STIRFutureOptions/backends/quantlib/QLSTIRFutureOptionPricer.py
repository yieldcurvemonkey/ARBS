...
@dataclass
class QLSTIRFutureOptionPricable(_STIRFutureOptionGenericPricable):
    _symbol: str
    _right: str
    _strike: float
...
@dataclass
class QLSTIRFutureOptionPricer(_STIRFutureOptionGenericPricer):
    _symbol: str
    _right: str
    ...
    def npv(self, instrument: _STIRFutureOptionGenericPricable, /, **kwargs: Any) -> float:
        _ = kwargs
        qty = float(getattr(instrument, "quantity", lambda: 1.0)())
        return self._market_price * qty

    def build_pricable(self, /, **kwargs: Any) -> _STIRFutureOptionGenericPricable:
        return QLSTIRFutureOptionPricable(
    ...
    def resolve_pricable(
        ...
        if isinstance(priceable, QLSTIRFutureOptionPricable):
